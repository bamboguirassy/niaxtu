...
@section('twitter-title',
    "Votre plateforme de publication des faits marquants qui gangrènent la société. Nous collectons
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="mbr-section-btn mt-3">
                        @auth
                            <a class="btn btn-lg btn-primary display-4" href="{{ route('post.new') }}"><span
            ...
            <div class="row right">
                <div class="col-12">
                    ...
                    <p class="mbr-text mbr-fonts-style display-7">
                        ...
                        administrations afin que cela serve à tous.</p>
                </div>
            </div>
        </div>
    </section>
